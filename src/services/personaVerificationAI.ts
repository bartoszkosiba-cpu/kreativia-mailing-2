...
${brief.additionalNotes ? `Dodatkowe notatki: ${brief.additionalNotes}` : ""}`
  ...
  const userPrompt = [
    ...
    "4. ⚠️ NIE WYMYŚLAJ informacji o działach - używaj TYLKO danych z pola 'departments' w danych pracownika. Jeśli w danych NIE MA informacji o dziale - NIE PISZ o dziale w uzasadnieniu!",
    "5. SPRAWDŹ kontekst biznesowy z briefu - to jest NAJWAŻNIEJSZE dla klasyfikacji (ale dopiero po sprawdzeniu reguł hardcoded)",
    "6. ZASTOSUJ reguły hardcoded (punkt 1-2) PRZED analizą na podstawie briefu - mają najwyższy priorytet!",
    "",
    briefSection,
    "",
    "ZASADY OGÓLNE:",
