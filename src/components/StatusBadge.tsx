...
export function StatusBadge({ 
  ...
  return (
    <div className={`inline-flex items-center gap-1 ${className}`}>
      {/* Main Status */}
      <div 
        className={`inline-flex items-center gap-1 rounded-lg font-medium text-white ${sizeClasses[size]}`}
      ...
      {showSubStatus && subStatus && (
        <div 
          className="inline-flex items-center gap-1 rounded-lg font-medium text-white text-xs px-2 py-1"
...
export function StatusBadgeCompact({ 
  ...
  return (
    <div 
      className={`inline-flex items-center gap-1 text-xs px-2 py-1 rounded-lg font-medium text-white ${className}`}
      style={{ backgroundColor: statusColor }}
