...
INSERT INTO "new_Company" (
  ...
  "description", "activityDescription", "descriptionPl", "activityDescriptionPl", "detectedLanguage", "translationUpdatedAt",
  "nip", "regon", "krs", "legalForm", "establishmentDate", "companySize", "employeeCount", "revenue", "netProfit",
  "locationCount", "ratingPoints", "keywords", "apolloAccountId", "sicCode", "naceCode",
...
SELECT
  "id", "name", "industry", "country", "city", "postalCode", "street", "buildingNumber", "website",
  "description", "activityDescription", NULL, NULL, NULL, NULL,
  "nip", "regon", "krs", "legalForm", "establishmentDate", "companySize", "employeeCount", "revenue", "netProfit",
  "locationCount", "ratingPoints", "keywords", "apolloAccountId", "sicCode", "naceCode",
  "importBatchId", "verificationStatus", "verificationResult", "verificationScore", "verificationReason",
  "verificationComment", "confidenceThreshold", "verifiedAt", "verifiedBy", "verificationSource",
